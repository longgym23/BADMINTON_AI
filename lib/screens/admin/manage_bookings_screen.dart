    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              child: Text("Không", style: TextStyle(color: Colors.grey[700], fontWeight: FontWeight.bold)),
              onPressed: () {
      ...
      body: Column(
        children: [
          ...
          Card(
            ...
            child: TableCalendar(
              locale: 'vi_VN',
              firstDay: DateTime.now().subtract(const Duration(days: 365)), // Cho phép xem quá khứ
              lastDay: DateTime.now().add(const Duration(days: 365)), // Cho phép xem tương lai
              ...
              headerStyle: HeaderStyle(
                ...
                titleTextStyle: TextStyle(color: colors.primary, fontSize: 16, fontWeight: FontWeight.bold),
              ),
              calendarStyle: CalendarStyle(
                ...
                selectedTextStyle: TextStyle(color: colors.primary, fontWeight: FontWeight.bold),
          ...
          Expanded(
            child: StreamBuilder<List<BookingModel>>(
              stream: repo.getAllBookingsForDay(_selectedDay), // <-- HÀM QUAN TRỌNG
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.isEmpty) {
                  return Center(
                    child: Text("Không có lịch đặt nào trong ngày này.",
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        // Nút Hủy
                        trailing: IconButton(
                          icon: Icon(Icons.delete_forever, color: Colors.red[700], size: 30),
