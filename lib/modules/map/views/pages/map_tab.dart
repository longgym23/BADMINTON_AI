...
import 'package:badminton_ai/modules/map/views/pages/map_view_model.dart';
...
class MapTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => MapViewModel(context.read<IBookingRepository>()),
...
class _MapTabContentState extends State<_MapTabContent> {
  ...
  Future<BitmapDescriptor> _createCustomMarkerBitmapFromAsset(
    ...
    try {
      ...
      // Fall back to circle-only marker if asset icon fails to load.
    }
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.place_rounded, color: VColors.brandPrimary, size: 18),
                SizedBox(width: 8),
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      gradient: LinearGradient(
                                        colors: [
                                          VColors.brandPrimary,
                                          VColors.brandPrimary.withValues(alpha: 0.75),
                                        ],
                                      ),
                                      borderRadius: BorderRadius.circular(20),
                                    ),
