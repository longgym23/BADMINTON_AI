...
class BookingCalendarTheme {
  ...
  static HeaderStyle headerStyle({TextFormatter? formatter}) {
    return HeaderStyle(
      ...
      titleCentered: true,
      leftChevronIcon: Icon(Icons.chevron_left, color: VColors.brandPrimary),
      rightChevronIcon: Icon(Icons.chevron_right, color: VColors.brandPrimary),
  ...
  static CalendarStyle get calendarStyle => CalendarStyle(
        ...
        todayDecoration: BoxDecoration(
          ...
          border: Border.fromBorderSide(
            BorderSide(color: VColors.brandPrimary, width: 1.5),
          ),
        ),
        ...
        holidayTextStyle: TextStyle(color: VColors.brandPrimary, fontSize: 14),
        // Cell spacing
  ...
  static BoxDecoration gridItemDecoration({required bool selected}) {
    return BoxDecoration(
      color: selected ? VColors.brandPrimary : Colors.grey[100],
  ...
  static TextStyle gridItemTextStyle({required bool selected, double fontSize = 13}) {
    return TextStyle(
      color: selected ? Colors.white : VColors.textPrimary,
  ...
  static Widget yearNavigator({
    ...
    return Row(
      ...
      children: [
        IconButton(
          icon: Icon(Icons.chevron_left, color: VColors.brandPrimary),
          onPressed: onPrevious,
        ),
        Text(label, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        IconButton(
          icon: Icon(Icons.chevron_right, color: VColors.brandPrimary),
          onPressed: onNext,
        ),
      ],
    );
