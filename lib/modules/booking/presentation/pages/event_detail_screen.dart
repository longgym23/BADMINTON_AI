...
import 'package:badminton_ai/modules/booking/presentation/pages/event_checkout_screen.dart';
...
class _EventDetailScreenState extends State<EventDetailScreen> {
  ...
  final Color bgColor = VColors.background;
            ...
            if (_isLoadingStatus) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: VColors.statusSuccess.withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(color: VColors.statusSuccess, width: 1),
                ),
                child: Row(
                  children: [
                    const Icon(Icons.check_circle, color: VColors.statusSuccess, size: 28),
              ...
              children: [
                if (!canBook) ...[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: VColors.statusCritical.withValues(alpha: 0.1),
                ...
                Text('screens.pitchTime'.tr(),
                  style: TextStyle(color: VColors.textPrimary),
                ),
                SizedBox(height: 4),
                Text(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 36,
                            decoration: BoxDecoration(
                              color: VColors.brandPrimaryLight,
                              borderRadius: BorderRadius.circular(8),
                            ),
                            child: Icon(
                              Icons.remove,
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      side: BorderSide(color: VColors.brandPrimary),
      ...
      child: Column(
        ...
        children: [
          if (title != null && icon != null) ...[
            Row(
              children: [
                Icon(icon, color: VColors.brandPrimary, size: 24),
                SizedBox(width: 8),
                Text(
                  title,
                  style: TextStyle(
