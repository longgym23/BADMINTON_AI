  ...
  Widget _buildReviewsList() {
    ...
    return Column(
      children: [
        ...
        Divider(height: 1, thickness: 1, color: VColors.borderDefault),
        Expanded(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: VColors.borderDefault.withValues(alpha: 0.5)),
      ),
      child: Column(
            ...
            children: [
              CircleAvatar(
                ...
                child: user?.photoUrl == null
                    ? Text(
                        initials,
                        style: TextStyle(color: VColors.brandPrimaryDark, fontWeight: FontWeight.bold),
                      )
                    : null,
              ),
              SizedBox(width: 12),
