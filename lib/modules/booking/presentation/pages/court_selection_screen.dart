...
import 'package:badminton_ai/modules/booking/presentation/pages/checkout_screen.dart';
...
class _CourtSelectionScreenState extends State<CourtSelectionScreen> {
  final Set<SelectedSlot> _selectedSlots = {};
  ...
  Future<void> _reserveAndGoCheckout() async {
    ...
    try {
      final result = await bookingProvider.reserveBookingSlots(
        courtId: widget.selectedCourt.id,
                  ...
                  children: [
                    TableCalendar(
                      ...
                      daysOfWeekStyle: DaysOfWeekStyle(
                        weekdayStyle: TextStyle(color: VColors.textSecondary),
                        weekendStyle: TextStyle(color: VColors.textSecondary),
                      ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _LegendItem(
                      ...
                      labelColor: VColors.textSecondary,
                      icon: Icons.block,
                      iconSize: 12,
                    ),
                    _LegendItem(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(color: VColors.textPrimary, fontSize: 13),
                  ),
                ),
              ],
            ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Table(
                              ...
                              border: TableBorder(
                                left: BorderSide(color: VColors.borderDefault),
                                right: BorderSide(color: VColors.borderDefault),
                                bottom: BorderSide(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: VColors
                            .brandPrimary, // Đổi màu sắc để khớp với Đặt Ngay
                        elevation: 0,
                        shape: RoundedRectangleBorder(
    ...
    return Row(
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: 12,
            color: labelColor ?? VColors.textPrimary,
            fontWeight: FontWeight.w500,
          ),
        ),
      ],
