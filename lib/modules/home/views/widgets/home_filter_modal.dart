...
import 'package:badminton_ai/core/utils/picker_utils.dart';
        ...
        Row(
          ...
          children: [
            ...
            OutlinedButton.icon(
              ...
              icon: const Icon(Icons.add, size: 16, color: VColors.brandPrimary),
              label: const Text('Tất cả', style: TextStyle(color: VColors.brandPrimary)),
  ...
  Widget _buildScheduleBtn(String label, String value) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? VColors.brandPrimarySubdued : Colors.white,
          border: Border.all(color: isSelected ? VColors.brandPrimary : Colors.grey[300]!),
        ...
        child: Text(
          ...
          style: TextStyle(
            color: isSelected ? VColors.brandPrimary : Colors.grey[600],
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          icon: const Icon(Icons.keyboard_arrow_down, color: VColors.brandPrimary),
          ...
          items: _eventFilters.map((f) => DropdownMenuItem(
            value: f['value'],
            child: Center(
              child: Text(f['label']!, style: const TextStyle(color: VColors.brandPrimary, fontSize: 15)),
            ),
          )).toList(),
  ...
  Widget _buildPriceSection() {
    return Column(
      ...
      children: [
        const Row(
          children: [
            Icon(Icons.monetization_on_outlined, color: VColors.brandPrimary, size: 20),
            SizedBox(width: 8),
        ...
        Text(
          ...
          style: const TextStyle(fontWeight: FontWeight.bold, color: VColors.textSecondary),
        ),
        SliderTheme(
          data: SliderThemeData(
            trackHeight: 10,
            activeTrackColor: VColors.brandPrimary,
            inactiveTrackColor: Colors.grey[300],
            thumbColor: Colors.white,
            overlayColor: VColors.brandPrimary.withValues(alpha: 0.2),
        ...
        const Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('50k', style: TextStyle(color: VColors.textSecondary, fontSize: 12)),
            Text('500k', style: TextStyle(color: VColors.textSecondary, fontSize: 12)),
          ],
        ),
      ],
    );
