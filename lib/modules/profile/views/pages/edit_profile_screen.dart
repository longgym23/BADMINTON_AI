...
class _EditProfileScreenState extends State<EditProfileScreen> {
          ...
          Expanded(
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle:
                    TextStyle(color: VColors.textSubdued, fontSize: 14),
    ...
    return Row(
      children: [
        ...
        if (isRequired) ...[
          ...
          const Text('*', style: TextStyle(color: VColors.brandPrimaryDark)),
        ],
      ],
    );
  }
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      enabled: enabled,
      style: TextStyle(
        color: enabled ? VColors.textPrimary : VColors.textSecondary,
      ),
      decoration: InputDecoration(
        hintText: hintText,
        hintStyle: TextStyle(color: VColors.textSubdued, fontSize: 14),
        fillColor: enabled ? Colors.white : VColors.background,
        filled: true,
