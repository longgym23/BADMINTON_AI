...
import 'package:badminton_ai/app/providers/language_provider.dart';
...
import 'package:badminton_ai/modules/profile/views/pages/favorites_screen.dart';
import 'package:badminton_ai/modules/profile/views/pages/settings_screen.dart';
...
import 'package:badminton_ai/modules/course/views/pages/course_main_screen.dart';
import 'package:badminton_ai/modules/course/views/pages/watched_courses_screen.dart';
...
import 'package:badminton_ai/core/utils/notification_utils.dart';
...
class ProfileTab extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(fontSize: 14, color: VColors.textSecondary),
              ),
              SizedBox(height: 24),
              _LangOption(
                flag: '🇻🇳',
  ...
  Widget _buildListItem({
    ...
    return ListTile(
      ...
      title: Text(
        title,
        style: TextStyle(color: VColors.textPrimary, fontSize: 15),
      ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? VColors.brandPrimarySubdued : Colors.grey[50],
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isSelected ? VColors.brandPrimary : VColors.borderDefault,
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isSelected ? VColors.brandPrimary : VColors.textPrimary,
              ),
            ),
            const Spacer(),
            if (isSelected)
