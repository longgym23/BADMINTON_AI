...
import 'package:badminton_ai/modules/profile/viewmodels/statistics_viewmodel.dart';
import 'package:badminton_ai/modules/profile/views/widgets/statistics_filter_row.dart';
...
class _StatisticsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: _buildAppBar(),
      body: vm.isLoading
          ? Center(child: CircularProgressIndicator(color: VColors.brandPrimary))
          : vm.error != null
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              ...
                              overflow: TextOverflow.ellipsis,
                              maxLines: 1,
                              style: TextStyle(color: VColors.brandPrimary, fontSize: 12),
                            ),
                          ),
                          SizedBox(width: 4),
                          Icon(Icons.close, size: 12, color: VColors.brandPrimary),
                        ],
                      ),
                    ),
                  ),
...
const _ChartSection({required this.distribution});
  ...
  Color _getColorForSport(String sportType) {
    switch (sportType.toLowerCase()) {
      case 'badminton':
        return VColors.brandPrimary; // Cam
      case 'football':
              ...
              return Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 13, color: VColors.textSecondary, fontWeight: FontWeight.w500),
                  ),
                ],
              );
            }).toList(),
