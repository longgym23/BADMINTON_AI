...
/// Data access port for the Friends feature.
abstract class IFriendRepository {
  /// Tìm user bằng số điện thoại (chính xác).
  Future<UserModel?> searchUserByPhone(String phone);

  /// Danh sách bạn bè đã được chấp nhận của user.
  Stream<List<UserModel>> watchFriendList(String userId);

  /// Danh sách lời mời kết bạn GỬI ĐẾN user.
  Stream<List<Map<String, dynamic>>> watchPendingRequests(String userId);
...
class FriendRepository implements IFriendRepository {
  ...
  Future<UserModel?> searchUserByPhone(String phone) async {
    try {
      ...
      debugPrint("Lỗi searchUserByPhone: $e");
      return null;
    }
  }
        ...
        .asyncMap((friendships) async {
          ...
          for (var f in friendships) {
            ...
            try {
              ...
              debugPrint("Lỗi load profile bạn bè: $e");
            }
          }
          return friends;
        });
        ...
        .asyncMap((friendships) async {
          ...
          for (var f in friendships) {
            ...
            try {
              ...
              debugPrint("Lỗi load profile người gửi lời mời: $e");
            }
          }
          return requestsInfo;
        });
  ...
  Future<String> checkRelationship(String myId, String otherId) async {
    try {
      ...
      debugPrint('Lỗi checkRelationship: $e');
      return 'none';
    }
  }
