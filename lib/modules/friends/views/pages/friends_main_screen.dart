...
import 'package:badminton_ai/modules/friends/views/pages/add_friend_screen.dart';
import 'package:badminton_ai/modules/chat/views/pages/chat_rooms_list_screen.dart';
import 'package:badminton_ai/modules/chat/views/pages/create_group_screen.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: _TabIndexListener(
        ...
        builder: (context, currentTab) => VPage(
          ...
          child: Material(
            ...
            child: ListTile(
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: friend.photoUrl != null
                          ...
                          : Icon(
                              Icons.person,
                              color: VColors.brandPrimary.withValues(alpha: 0.7),
                            ),
                    ),
                  ),
                  if (isOnline)
              ...
              subtitle: Text(
                friend.phoneNumber ?? '',
                style: TextStyle(
                  color: VColors.textSecondary.withValues(alpha: 0.9),
                  fontSize: 12,
                ),
              ),
              trailing: Row(
                        ...
                        leading: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: sender.photoUrl != null
                                ...
                                : Icon(
                                    Icons.person,
                                    color: VColors.brandPrimary.withValues(
                                      alpha: 0.7,
                                    ),
                                  ),
                          ),
