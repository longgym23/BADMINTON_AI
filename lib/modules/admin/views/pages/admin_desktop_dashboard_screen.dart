...
import 'package:badminton_ai/modules/admin/viewmodels/admin_dashboard_viewmodel.dart';
...
import 'package:badminton_ai/core/utils/wallet_dialog_utils.dart';
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          Container(
            width: 280,
            color: VColors.brandNavy, // Dark Blue of Dai Nam University
            child: Column(
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected 
                                  ? VColors.brandPrimary.withValues(alpha: 0.15) 
                                  : Colors.transparent,
                              borderRadius: BorderRadius.circular(10),
                              border: Border.all(
                                color: isSelected 
                                    ? VColors.brandPrimary.withValues(alpha: 0.3) 
                                    : Colors.transparent,
                                width: 1,
                              ),
                            ),
                            child: Row(
                              children: [
                                Icon(
                                  item.icon,
                                  color: isSelected ? VColors.brandPrimary : Colors.grey.shade400,
                                  size: 20,
                                ),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 20,
                        backgroundColor: VColors.brandPrimary.withValues(alpha: 0.2),
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: const Text(
                        "Xem tất cả lịch",
                        style: TextStyle(color: VColors.brandPrimary, fontFamily: 'Arial'),
                      ),
                    ),
                  ],
                ),
      ...
      LineChartData(
        ...
        lineTouchData: LineTouchData(
          touchTooltipData: LineTouchTooltipData(
            getTooltipColor: (_) => VColors.brandNavy,
          ...
          LineChartBarData(
            ...
            belowBarData: BarAreaData(
              ...
              gradient: LinearGradient(
                colors: [
                  VColors.brandPrimary.withValues(alpha: 0.3),
                  VColors.brandPrimary.withValues(alpha: 0.0),
                ],
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: const Text("Chọn", style: TextStyle(color: VColors.brandPrimary, fontWeight: FontWeight.bold, fontFamily: 'Arial')),
            ),
          ],
        );
      },
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String?>(
                ...
                hint: const Text("Tất cả các sân", style: TextStyle(fontSize: 14, fontFamily: 'Arial', color: VColors.textSecondary)),
                items: [
  ...
  Widget _buildFilterChip({
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? VColors.brandPrimary : Colors.grey.shade50,
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: isSelected ? VColors.brandPrimary : Colors.grey.shade300,
          ),
        ),
        child: Text(
          label,
  ...
  Widget _buildLegendRow(String title, Color color) {
    return Row(
      children: [
        ...
        Text(
          title,
          style: const TextStyle(fontSize: 13, color: VColors.textPrimary),
        ),
      ],
    );
  }
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  CircleAvatar(
                                    radius: 18,
                                    backgroundColor: VColors.brandPrimary.withValues(alpha: 0.1),
                                    child: Text(
                              ...
                              Checkbox(
                                activeColor: VColors.brandPrimary,
                                value: perms['courts'],
        ...
        children: [
          ...
          ...permissions.map((p) => Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Icon(Icons.check_circle_outline, color: VColors.brandPrimary, size: 16),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    p,
                    style: const TextStyle(fontSize: 12.5, color: VColors.textPrimary),
                  ),
                ),
              ],
            ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              court.name,
                              style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: VColors.textPrimary),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: const TextStyle(color: VColors.brandPrimary, fontWeight: FontWeight.bold, fontSize: 14),
                                ),
                                Container(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  ...
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: VColors.textPrimary),
                ),
                const SizedBox(height: 20),
                vm.bookings.isEmpty
                    ? Container(
