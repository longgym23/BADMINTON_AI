...
import 'package:badminton_ai/modules/chat/viewmodels/chat_rooms_bloc.dart';
      ...
      child: BackdropFilter(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: VColors.brandPrimary.withValues(alpha: 0.15),
                blurRadius: 15,
        ...
        if (isOnline)
          Positioned(
            ...
            child: Container(
              ...
              height: 14,
              decoration: BoxDecoration(
                color: VColors.statusSuccess, // Màu xanh lá khi online
                shape: BoxShape.circle,
        ...
        Text(
          ...
          style: TextStyle(
            color: (room.unreadCount > 0)
                ? VColors.textPrimary
                : VColors.textSecondary.withValues(alpha: 0.9),
            fontSize: 13.5,
      ...
      child: Column(
        ...
        children: [
          Icon(
            ...
            color: isTimeout ? Colors.orange : VColors.statusCritical,
            size: 48,
          ),
          SizedBox(height: 16),
          Padding(
            ...
            child: Text(
              displayMessage,
              textAlign: TextAlign.center,
              style: TextStyle(color: VColors.textSecondary, height: 1.5),
            ),
          ),
          SizedBox(height: 16),
          ElevatedButton(
